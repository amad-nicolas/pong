...
vy_bola = 7
v_jogador = 7
v_inimigo = 3  # Ajuste a velocidade do inimigo para torná-lo mais lento
pontos_jogador = 0
pontos_inimigo = 0
fonte = pygame.font.Font('freesansbold.ttf', 45)

def animacaoBola():
    global vx_bola, vy_bola, pontos_jogador, pontos_inimigo
...
def reiniciarJogo():
    global pontos_jogador, pontos_inimigo
...
while True:
    ...
    tela.blit(placar_jogador, (400, 50))
    tela.blit(placar_inimigo, (600, 50))
